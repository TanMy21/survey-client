...
const SingleChoiceListItem = ({ response, selected, onSelect }: SingleChoiceListItemProps) => {
  return (
    <div
      onClick={onSelect}
      className="mx-auto mb-1.5 flex min-h-[72px] w-full cursor-pointer flex-row items-center gap-2 rounded-4xl border border-gray-300 bg-[#f8f9fc] p-2 shadow-[8px_8px_24px_#e0e0e0,-8px_-8px_24px_#ffffff] transition-shadow duration-200 hover:bg-[#f5f7ff] hover:shadow-[0_4px_12px_rgba(80,84,255,0.12)] md:min-h-[64px]"
    >
